...
const SelectTrigger = ({ className, children, ...props }: AriaButtonProps) => (
  <AriaButton
    className={composeRenderProps(className, (className) =>
      cn(
        "flex gap-2 h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background",
        /* Disabled */
...
function JollySelect<T extends object>({
  ...
  return (
    ...
    >
      ...
      <SelectPopover placement={placement} className={popOverClassName}>
